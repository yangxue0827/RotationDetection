...
class DetectionNetworkKF(DetectionNetworkBase):

    def __init__(self, cfgs, is_training):
        super(DetectionNetworkKF, self).__init__(cfgs, is_training)
    ...
    def build_whole_detection_network(self, input_img_batch, gtboxes_batch_h=None, gtboxes_batch_r=None, gpu_id=0):
        ...
        if self.is_training:
            with tf.variable_scope('build_loss'):
                ...
                # reg_sigma = self.losses.kalman_filter_iou(rpn_box_pred, anchor_states, target_boxes, anchors, mode=1)
