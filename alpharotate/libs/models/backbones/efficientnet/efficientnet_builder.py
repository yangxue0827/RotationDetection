...
from alpharotate.libs.models.backbones.efficientnet import efficientnet_model
from alpharotate.libs.models.backbones.efficientnet import utils
...
class EfficientNetBackbone(object):
    ...
    def efficientnet(self, width_coefficient=None,
    ...
    def get_model_params(self, model_name, override_params):
      ...
      if model_name.startswith('efficientnet'):
        width_coefficient, depth_coefficient, _, dropout_rate = (
            self.efficientnet_params(model_name))
        global_params = self.efficientnet(
