...
class TestICDAR2015R3DetKF(TestICDAR2015):
    ...
    def eval(self):
        ...
        r3det_kf = build_whole_network.DetectionNetworkR3DetKF(cfgs=self.cfgs,
                                                               is_training=False)
        self.test_icdar2015(det_net=r3det_kf, real_test_img_list=real_test_img_list, txt_name=txt_name)
...
if __name__ == '__main__':
    ...
    tester = TestICDAR2015R3DetKF(cfgs)
    tester.eval()
