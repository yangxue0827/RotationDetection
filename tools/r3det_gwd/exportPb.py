...
from alpharotate.libs.models.detectors.r3det_gwd import build_whole_network_pb
...
CKPT_PATH = '../../output/trained_weights/{}/swa_15.ckpt'.format(cfgs.VERSION)
OUT_DIR = '../../output/Pbs'
PB_NAME = 'R3Det_GWD.pb'
...
class ExportPb(object):
    ...
    def build_detection_graph(self):
        r3det_gwd = build_whole_network_pb.DetectionNetworkR3DetGWD(cfgs=self.cfgs, is_training=False)
        ...
        box_pred, cls_prob, proposal = r3det_gwd.build_whole_detection_network(input_img_batch=img_batch)
    ...
    def test_pb(self, frozen_graph_path, test_dir):
        ...
        with tf.Session(graph=graph) as sess:
            for img_path in os.listdir(test_dir):
                ...
                short_size, max_len = self.cfgs.IMG_SHORT_SIDE_LEN[0], cfgs.IMG_MAX_LENGTH
                if raw_h < raw_w:
...
if __name__ == '__main__':
    ...
    exporter.test_pb('../../output/Pbs/R3Det_GWD_Frozen.pb',
