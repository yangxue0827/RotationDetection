...
def parse_args():
    ...
    """
    parser = argparse.ArgumentParser(description='Test FDDB')
    parser.add_argument('--img_dir', dest='img_dir',
                        help='images path',
                        default='/data/dataset_share/FDDB/test/images', type=str)
    ...
    parser.add_argument('--test_annotation_path', dest='test_annotation_path',
                        ...
                        default='/data/dataset_share/FDDB/test/xml', type=str)
        ...
        with tf.Session(config=config) as sess:
            ...
            for a_img_name in pbar:
                ...
                if self.args.draw_imgs:
                    ...
                    save_dir = os.path.join('test_fddb', self.cfgs.VERSION, 'fddb_img_vis')
