...
from alpharotate.libs.models.detectors.fcos import build_whole_network_batch_rbox
...
class TrainFCOS(Train):
    ...
    def main(self):
        with tf.Graph().as_default() as graph, tf.device('/cpu:0'):
            ...
            fcos = build_whole_network_batch_rbox.DetectionNetworkFCOS(cfgs=self.cfgs,
                                                                       is_training=True)
            ...
            for i in range(num_gpu):
                ...
                inputs_list.append([img, gtboxes_and_label_h,
                                    gtboxes_and_label_r, num_objects, img_h, img_w])
