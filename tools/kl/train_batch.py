...
from alpharotate.libs.models.detectors.kl import build_whole_network_batch
...
class TrainRetinaNet(Train):
    ...
    def main(self):
        with tf.Graph().as_default() as graph, tf.device('/cpu:0'):
            ...
            kl = build_whole_network_batch.DetectionNetworkKL(cfgs=self.cfgs, is_training=True)
                        ...
                        with tf.name_scope('tower_%d' % i):
                            with slim.arg_scope(
                                ...
                                with slim.arg_scope([slim.conv2d, slim.conv2d_in_plane,
                                    ...
                                    outputs = kl.build_whole_detection_network(input_img_batch=img,
            ...
            self.log_printer(kl, optimizer, global_step, tower_grads, total_loss_dict, num_gpu * cfgs.BATCH_SIZE, graph)
