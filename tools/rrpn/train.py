...
from alpharotate.libs.models.detectors.rrpn import build_whole_network
...
class TrainRRPN(Train):
    ...
    def main(self):
        with tf.Graph().as_default() as graph, tf.device('/cpu:0'):
            ...
            rrpn = build_whole_network.DetectionNetworkRRPN(cfgs=self.cfgs,
                                                            is_training=True)
                        ...
                        with tf.name_scope('tower_%d' % i):
                            with slim.arg_scope(
                                ...
                                with slim.arg_scope([slim.conv2d, slim.conv2d_in_plane,
                                    ...
                                    outputs = rrpn.build_whole_detection_network(input_img_batch=img,
            ...
            self.log_printer(rrpn, optimizer, global_step, tower_grads, total_loss_dict, num_gpu, graph)

if __name__ == '__main__':

    trainer = TrainRRPN(cfgs)
    trainer.main()
