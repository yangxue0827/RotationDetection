...
from alpharotate.libs.utils.coordinate_convert import get_horizen_minAreaRectangle
from alpharotate.utils.pretrain_zoo import PretrainModelZoo

os.environ["CUDA_VISIBLE_DEVICES"] = cfgs.GPU_GROUP


class TrainRIDet(Train):
    ...
    def main(self):
        with tf.Graph().as_default() as graph, tf.device('/cpu:0'):
                        ...
                        with tf.name_scope('tower_%d' % i):
                            with slim.arg_scope(
                                ...
                                with slim.arg_scope([slim.conv2d, slim.conv2d_in_plane,
                                    ...
                                    outputs = ridet.build_whole_detection_network(input_img_batch=img,
            ...
            self.log_printer(ridet, optimizer, global_step, tower_grads, total_loss_dict, num_gpu, graph)

if __name__ == '__main__':

    trainer = TrainRIDet(cfgs)
    trainer.main()
