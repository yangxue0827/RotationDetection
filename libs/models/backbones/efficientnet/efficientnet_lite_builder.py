...
from libs.models.backbones.efficientnet import efficientnet_builder
from libs.models.backbones.efficientnet import efficientnet_model
from libs.models.backbones.efficientnet import utils


class EfficientNetLiteBackbone(object):

    def __init__(self, cfgs):
        self.cfgs = cfgs
        # Edge models use inception-style MEAN and STDDEV for better post-quantization.
        self.MEAN_RGB = [127.0, 127.0, 127.0]
        self.STDDEV_RGB = [128.0, 128.0, 128.0]
        self._DEFAULT_BLOCKS_ARGS = [
    ...
    def efficientnet_lite_params(self, model_name):
    ...
    def efficientnet_lite(self, width_coefficient=None,
                          depth_coefficient=None,
                          dropout_rate=0.2,
                          survival_prob=0.8):
      """Creates a efficientnet model."""
      global_params = efficientnet_model.GlobalParams(
          blocks_args=self._DEFAULT_BLOCKS_ARGS,
    ...
    def get_model_params(self, model_name, override_params):
      ...
      if model_name.startswith('efficientnet-lite'):
        width_coefficient, depth_coefficient, _, dropout_rate = (
            self.efficientnet_lite_params(model_name))
        global_params = self.efficientnet_lite(
