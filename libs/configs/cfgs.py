...
# ------------------------------------------------
VERSION = 'RetinaNet_DOTA_2x_20201109'
NET_NAME = 'darknet'  # 'MobilenetV2'
...
if NET_NAME.startswith("resnet"):
    ...
    weights_name = "darknet/darknet"
else:
    raise Exception('net name must in [resnet, MobilenetV2, darknet]')
