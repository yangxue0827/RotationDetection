...
"""
r3det+gwd (only refine stage) + sqrt tau=2 + data aug. + ms + res152 + 3x + 5*256conv head + mss
FLOPs: 1096705578;    Trainable params: 74667448

"""

# ------------------------------------------------
VERSION = 'RetinaNet_DOTA_R3Det_GWD_3x_20210111'
