...
"""
R2CNN+KL
FLOPs: 1237516010;    Trainable params: 41766526
This is your result for task 1:

mAP: 0.6914703452427697
ap of each class: plane:0.8889143762037581, baseball-diamond:0.7542885441827097, bridge:0.4208017194117489, ground-track-field:0.6272991334652956, small-vehicle:0.7271847675874282, large-vehicle:0.7257497067020519, ship:0.8513549249847303, tennis-court:0.8945964095158834, basketball-court:0.8455410507392794, storage-tank:0.8473745041237538, soccer-ball-field:0.4555356501131034, roundabout:0.5677207109821194, harbor:0.573397282136529, swimming-pool:0.6636171053919053, helicopter:0.5286792931012501
The submitted information is :

Description: FPN_Res50D_DOTA_KL_1x_20210316_45.9w
Username: SJTU-Det
Institute: SJTU
...
# ------------------------------------------------
VERSION = 'FPN_Res50D_DOTA_KL_1x_20210316'
...
RPN_LOCATION_LOSS_WEIGHT = 10.
RPN_CLASSIFICATION_LOSS_WEIGHT = 10.0
FAST_RCNN_LOCATION_LOSS_WEIGHT = 1.0
FAST_RCNN_CLASSIFICATION_LOSS_WEIGHT = 5.0
RPN_SIGMA = 3.0
FASTRCNN_SIGMA = 1.0
...
ANCHOR_SCALES = [1.0]
ANCHOR_RATIOS = [0.5, 1., 2.0, 0.25, 4.0]
